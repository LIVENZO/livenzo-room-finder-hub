...
const ReferralBanner: React.FC = () => {
  ...
  return (
    <div className="w-full mt-8">
      <div className="relative overflow-hidden rounded-2xl border border-primary/10 bg-primary/[0.03] p-5 sm:p-6">
        ...
        <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <Button
            ...
            className="shrink-0 h-11 rounded-full bg-[#25D366] hover:bg-[#1DA851] text-white font-semibold px-5 text-sm shadow-lg shadow-[#25D366]/20 active:scale-[0.97] transition-all duration-200"
          >
            {isLoading ? (
              <>
