...
const ReferralBanner: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-r from-primary/95 to-primary-foreground/10 backdrop-blur-sm border-t border-primary/20 shadow-lg">
      <div className="container max-w-6xl py-3 px-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-2 text-center sm:text-left">
            ...
            <p className="text-sm sm:text-base font-medium text-primary-foreground">
              ...
              <span className="block sm:inline text-xs sm:text-sm opacity-90">
                Earn ₹200 when they complete their first booking
              </span>
            </p>
          </div>
          ...
          <Button
            ...
            className="bg-green-500 hover:bg-green-600 text-white font-medium px-4 py-2 rounded-full text-sm whitespace-nowrap"
          >
            {isLoading ? (
              <>
