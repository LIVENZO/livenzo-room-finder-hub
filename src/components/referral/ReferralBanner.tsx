  ...
  return <div className="w-full bg-gradient-to-r from-primary/95 to-primary-foreground/10 border-t border-primary/20 shadow-lg rounded-lg mt-8">
      <div className="py-4 px-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <Button onClick={handleShare} disabled={isLoading || !user} className="bg-green-500 hover:bg-green-600 text-white font-medium px-4 py-2 rounded-full text-sm whitespace-nowrap">
            {isLoading ? <>
