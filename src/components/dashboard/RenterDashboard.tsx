    ...
    <div className="space-y-8 animate-fade-in">
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div
            className="inline-flex items-center justify-center w-16 h-16 bg-gradient-primary rounded-2xl shadow-lg animate-float cursor-pointer hover:scale-105 transition-transform"
            onClick={() => navigate("/find-room")}
          >
      ...
      <Card className="border-0 shadow-soft bg-white/80 backdrop-blur-sm">
        <CardHeader>
          <CardTitle className="text-xl font-display font-bold text-gray-900">Quick Access</CardTitle>
        </CardHeader>
        <CardContent>
