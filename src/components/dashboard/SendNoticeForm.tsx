  ...
  return <Card>
      ...
      <CardContent>
        <div className="space-y-3">
          <Textarea placeholder="Type your notice message here..." value={message} onChange={e => setMessage(e.target.value)} className="min-h-[120px]" disabled={isSending} />
        </div>
      </CardContent>
      <CardFooter className="flex justify-end">
        <Button onClick={handleSendNotice} disabled={!message.trim() || isSending}>
          {isSending ? <>
