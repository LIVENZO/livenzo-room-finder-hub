          ...
          <div className="space-y-3 pt-4 border-t">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button variant="outline" onClick={() => document.getElementById('proof')?.click()} className="flex-1">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="notes" placeholder="Any additional notes about the payment" value={notes} onChange={e => setNotes(e.target.value)} rows={2} />
            </div>
          </div>
