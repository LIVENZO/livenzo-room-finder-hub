        ...
        return (
          <motion.div
            ...
            <RadioGroup
              ...
              className="space-y-3">
              <label className={`flex items-center space-x-3 p-4 rounded-xl border-2 cursor-pointer transition-all ${userType === 'student' ? 'border-primary bg-primary/5' : 'border-border hover:border-primary/50'}`}>
              ...
              <label className={`flex items-center space-x-3 p-4 rounded-xl border-2 cursor-pointer transition-all ${userType === 'professional' ? 'border-primary bg-primary/5' : 'border-border hover:border-primary/50'}`}>
      ...
      case 'details':
        return (
          <motion.div
            ...
            exit="exit"
            className="space-y-6">
            <button onClick={() => setStep('user-type')} className="flex items-center text-sm text-muted-foreground hover:text-foreground transition-colors">
      ...
      case 'duration':
        return (
          <motion.div
            ...
            exit="exit"
            className="space-y-6">
            <button onClick={() => setStep('details')} className="flex items-center text-sm text-muted-foreground hover:text-foreground transition-colors">
              <ArrowLeft className="h-4 w-4 mr-1" /> Back
            </button>
            <div className="text-center">
        ...
        return (
          <motion.div
            ...
            <div className="space-y-3">
              <Button variant="outline" className="w-full h-12 text-base font-medium" onClick={handleChangeDuration}>
                Change Duration
              </Button>
              <Button className="w-full h-12 text-base font-medium" onClick={handleClose}>
                Done
              </Button>
            </div>
          </motion.div>);
          ...
          <motion.div
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-xl p-5 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground">Hustle Free Room Booking.
                  </p>
      ...
      case 'drop-schedule':
        ...
        return (
          <motion.div
            ...
            exit="exit"
            className="space-y-5">
            <button onClick={() => setStep('token-confirm')} className="flex items-center text-sm text-muted-foreground hover:text-foreground transition-colors">
              <ArrowLeft className="h-4 w-4 mr-1" /> Back
            </button>
            ...
            <motion.div
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mt-1 leading-relaxed">Pay the booking confirmation fee to secure this room before someone else does.</p>
                </div>
              </div>
      ...
      case 'failed':
        return (
          <motion.div
            ...
            <div className="space-y-3">
              <Button className="w-full h-12 text-base font-medium" onClick={handleRetryPayment}>
                Retry Payment
              </Button>
