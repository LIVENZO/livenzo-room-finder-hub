...
const FindRoom: React.FC = () => {
  ...
  return (
    <Layout>
      ...
      <div
        className={cn(
          "fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-border/50 shadow-sm transition-transform duration-300 ease-out",
          "md:left-[280px]",
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        {!isLoading && filteredRooms.length === 0 &&
          <Card className="mb-3 sm:mb-6 overflow-hidden border border-border/60 bg-card/50 backdrop-blur-sm">
